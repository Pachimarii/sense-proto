...
(function (global, factory) {
  ...
  (global = global || self, global.ScrollWatcher = factory());
  ...
  Internal.prototype.handleItems = function handleItems () {
    ...
    var evtData = this.getScrollData();
  ...
  Internal.prototype.getScrollData = function getScrollData () {
    var xy = getScroll();
    var scrollingDown = xy[1] > this.lastXY[1];
    this.lastXY = xy;
    return {
      scrollX: xy[0],
      scrollY: xy[1],
   ...
   * @class Base
   */
  var Base = /*@__PURE__*/(function (TinyEmitter) {
    function Base() {
    ...
    if ( TinyEmitter ) Base.__proto__ = TinyEmitter;
    Base.prototype = Object.create( TinyEmitter && TinyEmitter.prototype );
    ...
    Base.prototype.watch = function watch (element, opt_offset) {
      ...
      return {
        ...
        update: function() {
          var item = Base.Internal.watching[idx];
          var data = Base.Internal.getScrollData();
